          ...
          <div className="relative pt-24">
            ...
            <div className="mx-auto max-w-5xl px-6">
              <div className="sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  Plan your Path to Graduation 10x Faster
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                ...
                >
                  TerpPlanner is the 4-year planning tool built for UMD
                  students. Import your transcript, track requirements, and make
                  sure you&apos;re on track to graduate on time
                </TextEffect>
                ...
                >
                  ...
                  <>
                    <SignedIn>
                      ...
                      >
                        <Link href="/planner">
                          <span className="text-nowrap">Go to Planner</span>
                        </Link>
                      </Button>
                    </SignedIn>
                  </>
